...
public class Inicio {
	...
	public static void main(String[] args) {
		...
		System.out.printf("o nome é %s, o salario é %.2f salario%n, a idade é %d e os metros são %.2f metros%n", nome, salario,idade, metros);
	
		double idade2 = 15.55;
		
		// Boa pratica é indicar o tipo de dado que voce esta usando, entao se for double colocar um .0 e um float usar uF depois do numero.
